...
#define GPIOA_DISABLE	(*(uint32_t *)(RCC_ADDRESS + 0x30UL) &= ~(0x1 << 0))
#define GPIOB_DISABLE	(*(uint32_t *)(RCC_ADDRESS + 0x30UL) &= ~(0x1 << 1))
#define GPIOC_DISABLE	(*(uint32_t *)(RCC_ADDRESS + 0x30UL) &= ~(0x1 << 2))
#define GPIOD_DISABLE	(*(uint32_t *)(RCC_ADDRESS + 0x30UL) &= ~(0x1 << 3))
#define GPIOE_DISABLE	(*(uint32_t *)(RCC_ADDRESS + 0x30UL) &= ~(0x1 << 4))
#define GPIOF_DISABLE	(*(uint32_t *)(RCC_ADDRESS + 0x30UL) &= ~(0x1 << 5))
#define GPIOG_DISABLE	(*(uint32_t *)(RCC_ADDRESS + 0x30UL) &= ~(0x1 << 6))
#define GPIOH_DISABLE	(*(uint32_t *)(RCC_ADDRESS + 0x30UL) &= ~(0x1 << 7))

#define GPIOA_ENABLE	(*(uint32_t *)(RCC_ADDRESS + 0x30UL) |= (0x1 << 0))
#define GPIOB_ENABLE	(*(uint32_t *)(RCC_ADDRESS + 0x30UL) |= (0x1 << 1))
#define GPIOC_ENABLE	(*(uint32_t *)(RCC_ADDRESS + 0x30UL) |= (0x1 << 2))
#define GPIOD_ENABLE	(*(uint32_t *)(RCC_ADDRESS + 0x30UL) |= (0x1 << 3))
#define GPIOE_ENABLE	(*(uint32_t *)(RCC_ADDRESS + 0x30UL) |= (0x1 << 4))
#define GPIOF_ENABLE	(*(uint32_t *)(RCC_ADDRESS + 0x30UL) |= (0x1 << 5))
#define GPIOG_ENABLE	(*(uint32_t *)(RCC_ADDRESS + 0x30UL) |= (0x1 << 6))
#define GPIOH_ENABLE	(*(uint32_t *)(RCC_ADDRESS + 0x30UL) |= (0x1 << 7))
